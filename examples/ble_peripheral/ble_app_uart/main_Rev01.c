...
static nrf_drv_adc_channel_t m_channel_config = NRF_DRV_ADC_DEFAULT_CHANNEL(NRF_ADC_CONFIG_INPUT_2); // AIN2 input is pin P0.01. Scale 1/1. Vref = 1.2V 10 bit
...
{
    ret_code_t ret_code;
    nrf_drv_adc_config_t config = NRF_DRV_ADC_DEFAULT_CONFIG;		//set priority of ADC interrupt
...
#define DEVICE_NAME                     "CNK TECH Labs"                               /**< Name of device. Will be included in the advertising data. */
